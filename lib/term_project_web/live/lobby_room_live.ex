...
#   # Modify countdown 0 handler to initialize game
#   def handle_info({:countdown, 0}, socket) do
#     case TermProject.Game.get_state(socket.assigns.lobby.id) do
#       {:ok, initial_state} ->
#         {:noreply,
#          socket
...
#          |> push_navigate(
#            to:
#              ~p"/game/#{socket.assigns.lobby.id}?username=#{URI.encode(socket.assigns.username)}"
#          )}
